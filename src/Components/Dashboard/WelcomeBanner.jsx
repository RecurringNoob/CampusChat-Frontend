  ...
  return (
    <div className="bg-gradient-to-r from-zinc-800 to-zinc-900 rounded-2xl border border-zinc-700 p-6 mb-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
        ...
        <button className="mt-4 md:mt-0 bg-emerald-500 hover:bg-emerald-600 rounded-full px-5 py-2 text-sm font-medium transition-colors" onClick={()=>{navigate("/waiting-room")}}>
          Start Random Chat
        </button>
      </div>
    </div>
